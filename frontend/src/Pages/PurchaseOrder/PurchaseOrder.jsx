...
//   // Fetch purchase orders on mount and when rowsPerPage changes
//   useEffect(() => {
//     fetchPurchaseOrders(1, rowsPerPage);
//   }, [rowsPerPage]);

//   // Fetch purchase orders with pagination
//   const fetchPurchaseOrders = async (pageNum, limit) => {
//     setLoading(true);
//     try {
...
//       setPage(pageNum - 1); // Adjust for zero-based indexing
//     } catch (err) {
...
//   // Search purchase orders
//   const searchPurchaseOrders = async (query, pageNum, limit) => {
//     if (query.trim().length < 2) {
//       await fetchPurchaseOrders(1, limit);
//       setPage(0);
//       setSearchLoading(false);
//       return;
//     }
...
//   const debouncedSearch = debounce((query, pageNum, limit) => {
//     searchPurchaseOrders(query, pageNum, limit);
//   }, 500);

//   const handleSearchChange = (e) => {
//     const query = e.target.value;
//     setSearchTerm(query);
//     debouncedSearch(query, 1, rowsPerPage);
//   };
...
//       searchPurchaseOrders(searchTerm, pageNum, rowsPerPage);
//     } else {
//       fetchPurchaseOrders(pageNum, rowsPerPage);
//     }
//   };
...
//     const pageNum = 1;
//     if (searchTerm.trim().length >= 2) {
//       searchPurchaseOrders(searchTerm, pageNum, newRowsPerPage);
//     } else {
//       fetchPurchaseOrders(pageNum, newRowsPerPage);
//     }
//   };
...
//         headers: { Authorization: `Bearer ${localStorage.getItem("authToken")}` },
//       });
//       const exportPurchaseOrders = response.data.purchaseOrders || [];
...
//         headers: { Authorization: `Bearer ${localStorage.getItem("authToken")}` },
//       });
//       const exportPurchaseOrders = Array.isArray(response.data.purchaseOrders) ? response.data.purchaseOrders : [];
